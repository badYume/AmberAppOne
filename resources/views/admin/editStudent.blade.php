...
<div class="w-full bg-grey-500">
    <div class="container mx-auto py-8">
        <div class="w-96 mx-auto bg-white rounded shadow">
            ...
            <div class="mx-16 py-4 px-8 text-black text-xl font-bold border-b border-grey-500"> Edit Application
            </div>

            <form name="student_application" id="student_application" action="{{route('admin.update',$student['id'])}}" method = POST>
                @csrf
                @method("PATCH")
                ...
                <div class="py-4 px-8">
                    ...
                    <div class="mb-4">
                        ...
                        <input class=" border rounded w-full py-2 px-3 text-grey-darker" type="text"
                               name="first_name_input" value="" placeholder="{{$student['first_nm']}}">
                    ...
                    <div class="mb-4">
                        ...
                        <input class=" border rounded w-full py-2 px-3 text-grey-darker" type="text"
                               name="last_name_input" value="" placeholder="{{$student['last_nm']}}">
                    ...
                    <div class="mb-4">
                        ...
                        <input class=" border rounded w-full py-2 px-3 text-grey-darker" type="date"
                               name="d_o_b_input" placeholder="{{$student['d_o_b']}}">
                    ...
                    <div class="mb-4">
                        ...
                        <input class=" border rounded w-full py-2 px-3 text-grey-darker" type="text"
                               name="class_input" value="" placeholder="{{$student['class']}}">
                    ...
                    <div class="mb-4">
                        ...
                        <input class=" border rounded w-full py-2 px-3 text-grey-darker" type="text"
                               name="phone_number_input" value="" placeholder="{{$student['phone_nbr']}}">
                    ...
                    <div class="mb-4">
                        ...
                        <input class=" border rounded w-full py-2 px-3 text-grey-darker" type="text"
                               name="email_input" value="" placeholder="{{$student['email_addr']}}">
                    ...
                    <div class="mb-4">
                        ...
                        <input class=" border rounded w-full py-2 px-3 text-grey-darker" type="text"
                               name="gender_input" value="" placeholder="{{$student['gender']}}">
